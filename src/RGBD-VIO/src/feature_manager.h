...
class FeaturePerId
{
  public:
    ...
    FeaturePerId(int _feature_id, int _start_frame)
        : feature_id(_feature_id), start_frame(_start_frame), depth_shift(0),
...
public:
    ...
    bool addFeatureCheckParallaxSigma_dvio(int frame_count, const map<int, vector<pair<int, Eigen::Matrix<double, 10, 1>>>> &image, bool finish_ini);
    void removeBackShiftDepth_dvio(Eigen::Matrix3d marg_R, Eigen::Vector3d marg_P, Eigen::Matrix3d new_R, Eigen::Vector3d new_P);
